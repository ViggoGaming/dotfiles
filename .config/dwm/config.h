...
static const char *altbarcmd        = "$HOME/.config/polybar/blocks/launch.sh"; /* Alternate bar launch command */
static const char *fonts[]          = { "monospace:size=14", "feather:size=12" };
/* static const char dmenufont[]       = "monospace:size=14"; */
/* static const char dmenufont[]       = "Iosevka,Iosevka Nerd Font:style=Regular,Book"; */
static const char dmenufont[]       = "FiraCode Nerd Font Mono:style=Regular";
...
static const char col_nord[]        = "#bf616a";
static const char col_nord_sel[]    = "#a3be8c";

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray1, col_gray1, col_nord },
	[SchemeSel]  = { col_gray1, col_gray1,  col_nord_sel },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-h", "36", NULL };
...
static Key keys[] = {
  ...
  { MODKEY,                       XK_s,      togglesticky,   {0} },
	...
	{ MODKEY,                       XK_i,      setlayout,      {.v = &layouts[11]} }, /* deck */
	{ MODKEY|ShiftMask,             XK_i,      setlayout,      {.v = &layouts[12]} }, /* monocle */
